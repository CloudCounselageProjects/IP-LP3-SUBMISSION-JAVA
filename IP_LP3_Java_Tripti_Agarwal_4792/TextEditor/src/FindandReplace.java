...
class FindReplace extends JFrame
{
	...
	FindReplace()
	{
		...
		{
			if(dialog==null)
				dialog=new FindandReplace(FindReplace.this.ta);
			dialog.showDialog(FindReplace.this,true);
	...
	ActionListener ac2=new ActionListener()
	{
		public void actionPerformed(ActionEvent ev)
		{
			if(dialog==null)
				dialog=new FindandReplace(FindReplace.this.ta);
				dialog.showDialog(FindReplace.this,false);
			}
	};
...
public class FindandReplace extends JPanel implements ActionListener
{
	JTextArea ta1;
	...
	public FindandReplace(JTextArea texta)
	{
