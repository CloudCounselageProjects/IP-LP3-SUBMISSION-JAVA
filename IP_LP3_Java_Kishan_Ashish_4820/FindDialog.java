...
public class FindDialog extends JPanel implements ActionListener
{
	...
	//-------------Enable an Disable button method-----------
	...
	//----------------findNextWithSelection event method-------------------
